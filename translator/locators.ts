...
export const saveCardBtn = document.querySelector('#saveCardBtn') as HTMLButtonElement;
export const saveCardBtnWrap = document.querySelector('#saveCardBtnWrap') as HTMLElement;
